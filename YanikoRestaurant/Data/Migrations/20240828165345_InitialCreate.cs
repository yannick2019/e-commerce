    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "A delicious taco with beef", "Beef Taco", 2.50m, 100 },
                    { 2, 2, "A delicious taco with chiken", "Chicken Taco", 1.90m, 90 },
                    { 3, 2, "A delicious taco with fish", "Fish Taco", 3.90m, 80 }
                });
